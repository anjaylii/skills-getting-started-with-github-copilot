...
activities.update({
    ...
    "Basketball Club": {
        "description": "Skill development and friendly games",
    ...
    "Drama Club": {
        "description": "Acting, improv, and school productions",
    ...
    "Science Olympiad": {
        "description": "Prepare for science competitions and hands-on events",
